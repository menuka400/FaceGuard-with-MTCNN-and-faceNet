...
def real_time_recognition(face_processor):
    ...
    refresh_interval = 10
    last_frame_time = 0  # Track the last time a frame was processed
    fps = 0  # Variable to store FPS
    
    while True:
        current_time = time.time()
        
        # Only process a frame if 1 second has passed since the last processed frame
        if current_time - last_frame_time >= 1.0:
            ...
            cv2.putText(frame, fps_text, (10, 30),  # Position at top-left corner
